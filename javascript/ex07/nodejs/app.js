...
app.get('/exam04-3', (req, res) => {
  ...
  let arr = [
    ...
    {no:2,title:'제목222222',writer:'임꺽정',viewCnt:312},
    {no:3,title:'제목333333',writer:'유관순',viewCnt:31},
    {no:4,title:'제목444444',writer:'안중근',viewCnt:100},
    {no:5,title:'제목555555',writer:'윤봉길',viewCnt:200}
  ];
...
app.post('/login', (req, res) => {
  ...
  payload += `패스워드: ${req.body.password}\n`;
