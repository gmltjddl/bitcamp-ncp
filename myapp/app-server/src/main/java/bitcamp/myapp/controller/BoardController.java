...
public class BoardController {
  ...
  @RequsetMapping("/board/form")
  public String form() {
    return "/board/form.jsp";
  }
  @RequsetMapping("/board/insert")
  public String insert(
      @RequsetParam("title") String title,
      @RequsetParam("content") String content,
      @RequsetParam("files") Part[] files,
  ...
  @RequsetMapping("/board/list") //value = "/board/list"  한개이면 생략가능
  public String list(
  ...
  @RequsetMapping("/board/delete")
  public String delete(
      @RequsetParam("no") int boardNo,
      HttpServletRequest request,
      HttpSession session) {
    try {
      Member loginUser = (Member) session.getAttribute("loginUser");
  ...
  @RequsetMapping("/board/filedelete")
  public String filedelete(
      @RequsetParam("boardNo") int boardNo,
      @RequsetParam("fileNo") int fileNo,
      HttpSession session) {
